...
class UnetDataset(keras.utils.Sequence):
    ...
    def __getitem__(self, index):
        ...
        for i in range(index * self.batch_size, (index + 1) * self.batch_size):  
            ...
            # add +1 because some labels in VOC dataset have white edges
            # ignore white edges
    ...
    def get_random_data(self, image, label, input_shape, jitter=.3, hue=.1, sat=0.7, val=0.3, random=True):
        ...
        # get height and width of image and target height and width
        iw, ih = image.size
        h, w = input_shape
        ...
        # resize image and distort its height and width
        ...
        # add grey bars to excess parts of the image
